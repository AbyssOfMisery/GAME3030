...
namespace View
{
    public class ATK_Items : BaseInventory, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        //define "target inventory block " name
        public string StrTargetGridName = "Img_ATK";

        public float FloAddPlayerMaxATK = 20.0f;
        ...
        protected override void InvokeMethodByEndDrag()
        {
            ...
            PlayerSaveDataProxy.GetInstance().IncreaseMaxATK(FloAddPlayerMaxATK);
            PlayerSaveDataProxy.GetInstance().UpdateATKValues();
        }
    }
